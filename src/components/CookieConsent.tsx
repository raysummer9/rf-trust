    ...
    <div className="fixed bottom-0 left-0 w-full z-50 flex justify-center items-end">
      <div className="bg-white shadow-2xl rounded-t-2xl w-full p-6 md:p-8 mb-0 md:mb-6 border border-gray-200">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-col w-full md:w-56 gap-4 md:ml-8">
            <button
              onClick={() => handleConsent("accepted")}
              className="w-full bg-[#338DF3] text-white font-semibold py-3 rounded-lg hover:bg-[#2563EB] transition text-lg"
            >
              Accept all cookies
            </button>
            <button
              onClick={() => handleConsent("refused")}
              className="w-full bg-gray-200 text-[#00012E] font-semibold py-3 rounded-lg hover:bg-gray-300 transition text-lg"
            >
